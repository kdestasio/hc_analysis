...
4. Identify the components of the attention bias measures to use in clustering (E.g. reaction time.)  
...
## 2. Split data into development and holdout, then training and testing
