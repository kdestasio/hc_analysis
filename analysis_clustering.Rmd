...
myfun_plotmeansbyclus <- function(clusters_to_plot, title){
    ...
    gather(., variable, measurement, rt_neutral_nt:peak_neg)
...
par(mfrow = c(1,2)) 
myfun_plotmeansbyclus(km_k2_res$cluster, 'K-Means PCA2 Clustering Solution: \n2 Clusters, Raw Variable Scores')
myfun_plotmeansbyclus(km_k3_res$cluster, 'K-Means PCA2 Clustering Solution: \n2 Clusters, Raw Variable Scores')
```
...
```{r save objects}
save(data_matrix_aim1, km_k2_res$cluster, pca_summary, pca_scaled, data_pca2components, kmeans_kcca, variable_means_km2, variable_means_km3, file = "clustering_objects.Rda")
